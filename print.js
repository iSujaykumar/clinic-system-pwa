...
<div class="vitals-box">
  <div class="vital">
    ...
    <span class="info-value">${elements.height.value}</span>
  </div>
  <div class="vital">
    <span class="info-label">Weight (kg)</span>
    <span class="info-value">${elements.weight.value}</span>
  </div>
  <div class="vital">
    <span class="info-label">Pulse (bpm)</span>
    <span class="info-value">${elements.pulse.value}</span>
  </div>
  <div class="vital">
  ...
  <div class="vital">
    ...
    <span class="info-value">${elements.rr.value}</span>
  </div>
  <div class="vital">
    <span class="info-label">Blood Sugar</span>
    <span class="info-value">${elements.sugar.value}</span>
  </div>
</div>
...
<div class="footer info-row">
  <div class="info-item">
    ...
    <span class="info-value">${elements.followup.value}</span>
  </div>
</div>
